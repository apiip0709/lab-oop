...
public class Main {
    ...
    private static void showDetailUser(Profile profile) {
        String name = StringUtils.nickname(listUserProfile.get(0).getFullName());
        ...
        System.out.println("------------------------------");
        System.out.println("Nama : " + listUserProfile.get(0).getFullName());
        System.out.println("Nickname : "+ name);
        System.out.println("Umur : " + listUserProfile.get(0).getAge());
        System.out.println("Hobby : " + listUserProfile.get(0).getHobby());
    }
}
